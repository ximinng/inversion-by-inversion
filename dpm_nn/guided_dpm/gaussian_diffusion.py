...
from .distribution import normal_kl, discretized_gaussian_log_likelihood
...
class GaussianDiffusion:
    ...
    Args:
        ...
        input_pertub: a very simple but effective training regularization,
                        consisting in perturbing the ground truth samples to
                        simulate the inference time prediction errors.
            reference: "Input Perturbation Reduces Exposure Bias in Diffusion Models"
            github: https://github.com/forever208/DDPM-IP
        p2_gamma:
        p2_k:
    """
    ...
    def p_mean_variance(
        ...
        if self.model_var_type in [ModelVarType.LEARNED, ModelVarType.LEARNED_RANGE]:
            ...
            if self.model_var_type == ModelVarType.LEARNED:
                ...
                # Sigma_\theta = exp( v*log(\beta) + (1-v)*log(\beta_tilde) )
    ...
    def _predict_xstart_from_xprev(self, x_t, t, xprev):
        ...
        # x_start = (x_prev - coef2 * x_t) / coef1
        return (
    ...
    def ddim_sample(
        ...
        # 2. get current and previous alpha_cumprod
        alpha_bar = extract(self.alphas_cumprod, t, x.shape)
        ...
        # Equation 12.
        # 4. compute "direction pointing to x_t" of equation (12)
        mean_pred = (
        ...
        # 5. compute x_{t-1} of equation (12)
        noise = th.randn_like(x)
    ...
    def ddim_reverse_sample(
        ...
        # Usually our model outputs epsilon, but we re-derive it
        # in case we used x_start or x_prev prediction.
        eps = (extract(self.sqrt_recip_alphas_cumprod, t, x.shape) * x - out["pred_xstart"]) \
    ...
    def _vb_terms_bpd(
        ...
        # the divergence of two gaussians
        kl = normal_kl(
    ...
    def training_losses(self, model, x_start, t, model_kwargs=None, noise=None):
        ...
        Args:
            ...
            x_start: the tensor of inputs, shape: [N x C x W x H].
        ...
        # trick: Input Perturbation in DDPMs
        ...
        if self.loss_type == LossType.KL or self.loss_type == LossType.RESCALED_KL:
            ...
            if self.model_var_type in [
                ...
                # it affect our mean prediction, here we apply stop-gradient to the mean.
            ...
            # Eq.(10) in iDDPM
            posterior_mean, _, _ = self.q_posterior_mean_variance(x_start=x_start, x_t=x_t, t=t)
            target_types = {
            ...
            # trick: P2 weighting
            weight = extract(1 / (self.p2_k + self.snr) ** self.p2_gamma, t, target.shape)
            # origin: terms["mse"] = mean_flat((target - model_output) ** 2)
