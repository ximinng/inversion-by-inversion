...
class ModelState:
    ...
    features:
        ...
        - Optimizer
        - EMA
        - Logger (default: python naive print)
        - Monitor (default: wandb)
    """
    ...
    def __init__(
        ...
        if results_folder is None or results_folder == "":
        ...
        # noting: can be understand as "results dir / methods / ablation study / your result"
