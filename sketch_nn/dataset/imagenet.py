...
class ImageNetDataset(ImageFolder):
    ...
    def __init__(self, root: str, split: str = 'train', download: Optional[str] = None, **kwargs: Any) -> None:
        ...
        super(ImageNetDataset, self).__init__(self.split_folder, **kwargs)
        self.root = root
    ...
    def get_meta_info(self):
        print(
            f"{str('-' * 50)}\n"
            f"Dataset: ImageNet-1K | Split: {self.split} \n"
            f"Total number of samples: {len(self.samples)}\n"
